...
const TranslatePage: React.FC<TranslatePageProps> = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      {/* translate button */}
      <button disabled={loading} className='bg-[#3ac543]  border-white p-3 m-2 flex justify-center items-center rounded-lg text-white font-semibold' onClick={handleTranslate}>{loading ? `Translating...` : `Translate 🔁`}</button>
